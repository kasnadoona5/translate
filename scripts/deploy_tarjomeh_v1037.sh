...
BACKUP="$BACKUP_ROOT/v1037-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1037-$STAMP"
CANDIDATE="translate_tarjomeh:candidate-v1037-$STAMP"
OVERLAY_DOCKERFILE=""
...
# v10.37 is code-only. Build explicitly on the exact running image instead of
...
OVERLAY_DOCKERFILE="$(mktemp /tmp/tarjomeh-v1037-overlay.XXXXXX.Dockerfile)"
