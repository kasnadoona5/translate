...
BACKUP="$BACKUP_ROOT/v1031-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1031-$STAMP"
CANDIDATE="translate_tarjomeh:candidate-v1031-$STAMP"
OVERLAY_DOCKERFILE=""
...
# v10.31 is code-only. Build explicitly on the exact running image instead of
...
OVERLAY_DOCKERFILE="$(mktemp /tmp/tarjomeh-v1031-overlay.XXXXXX.Dockerfile)"
