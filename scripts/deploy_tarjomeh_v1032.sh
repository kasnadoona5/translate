...
BACKUP="$BACKUP_ROOT/v1032-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1032-$STAMP"
CANDIDATE="translate_tarjomeh:candidate-v1032-$STAMP"
OVERLAY_DOCKERFILE=""
...
# v10.32 is code-only. Build explicitly on the exact running image instead of
...
OVERLAY_DOCKERFILE="$(mktemp /tmp/tarjomeh-v1032-overlay.XXXXXX.Dockerfile)"
