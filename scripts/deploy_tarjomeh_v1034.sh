...
BACKUP="$BACKUP_ROOT/v1034-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1034-$STAMP"
CANDIDATE="translate_tarjomeh:candidate-v1034-$STAMP"
OVERLAY_DOCKERFILE=""
...
# v10.34 is code-only. Build explicitly on the exact running image instead of
...
OVERLAY_DOCKERFILE="$(mktemp /tmp/tarjomeh-v1034-overlay.XXXXXX.Dockerfile)"
