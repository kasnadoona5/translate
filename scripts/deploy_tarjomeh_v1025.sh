...
BACKUP="$BACKUP_ROOT/v1025-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1025-$STAMP"
CANDIDATE="translate_tarjomeh:candidate-v1025-$STAMP"
...
# v10.25 is code-only. Keeping the running image allows Docker to reuse its
...
git diff --quiet v10.24.1 "$TAG" -- Dockerfile pyproject.toml || {
