...
BACKUP="$BACKUP_ROOT/v1016-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1016-$STAMP"
...
checks = {
    ...
    "predicate_monotonic_guard": "finite_predicate_removed" in sources["pipeline"],
...
checks = {
    ...
    "predicate_monotonic_guard": "finite_predicate_removed" in p,
    "readability_source_authority": (
