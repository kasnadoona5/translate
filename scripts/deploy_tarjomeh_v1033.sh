...
BACKUP="$BACKUP_ROOT/v1033-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1033-$STAMP"
CANDIDATE="translate_tarjomeh:candidate-v1033-$STAMP"
OVERLAY_DOCKERFILE=""
...
# v10.33 is code-only. Build explicitly on the exact running image instead of
...
OVERLAY_DOCKERFILE="$(mktemp /tmp/tarjomeh-v1033-overlay.XXXXXX.Dockerfile)"
