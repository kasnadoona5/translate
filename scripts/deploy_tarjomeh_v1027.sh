...
BACKUP="$BACKUP_ROOT/v1027-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1027-$STAMP"
CANDIDATE="translate_tarjomeh:candidate-v1027-$STAMP"
...
# v10.27 is code-only. Keeping the running image allows Docker to reuse its
...
git diff --quiet v10.26.0 "$TAG" -- Dockerfile pyproject.toml || {
