...
BACKUP="$BACKUP_ROOT/v1020-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1020-$STAMP"
...
if [ "$AVAILABLE_KB" -lt 1450000 ]; then
    echo "STOPPED: less than 1.45 GB is available after safe cleanup."
