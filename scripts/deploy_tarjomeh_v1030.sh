...
BACKUP="$BACKUP_ROOT/v1030-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1030-$STAMP"
CANDIDATE="translate_tarjomeh:candidate-v1030-$STAMP"
OVERLAY_DOCKERFILE=""
...
# v10.30 is code-only. Build explicitly on the exact running image instead of
...
OVERLAY_DOCKERFILE="$(mktemp /tmp/tarjomeh-v1030-overlay.XXXXXX.Dockerfile)"
