...
BACKUP="$BACKUP_ROOT/v1036-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1036-$STAMP"
CANDIDATE="translate_tarjomeh:candidate-v1036-$STAMP"
OVERLAY_DOCKERFILE=""
...
# v10.36 is code-only. Build explicitly on the exact running image instead of
...
OVERLAY_DOCKERFILE="$(mktemp /tmp/tarjomeh-v1036-overlay.XXXXXX.Dockerfile)"
