...
BACKUP="$BACKUP_ROOT/v1026-$STAMP"
ROLLBACK="translate_tarjomeh:rollback-v1026-$STAMP"
CANDIDATE="translate_tarjomeh:candidate-v1026-$STAMP"
...
# v10.26 is code-only. Keeping the running image allows Docker to reuse its
...
git diff --quiet v10.25.0 "$TAG" -- Dockerfile pyproject.toml || {
